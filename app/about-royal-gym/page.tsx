      ...
      <div className="bg-white relative">
        <div className="templateContainer overflow-hidden py-6 lg:py-12 space-y-6">
          <p className="paraDesign" data-aos="fade-left">
            ...
            inspire and empower women. Set in a space that reflects its roots,
            our gym has become known for its dynamic atmosphere, cutting-edge
            design, motivating vibe, and a commitment to fitness freedom.
          </p>
          ...
          <p className="paraDesign" data-aos="fade-right">
            ...
            passionate individuals who see exercise as an essential part of
            life. We cultivate a supportive and motivating environment where
            members come together to celebrate milestones and inspire one
            another.
          </p>
          <p className="paraDesign" data-aos="fade-left">
            At Royal Gym, passion drives everything we do. Join us and be part
            of a community where fitness is a way of life.
          </p>
          <hr />
          ...
          <p className="paraDesign !text-right" data-aos="fade-right">
            ...
            النساء. في مساحة تعكس جذورها، أصبح نادينا معروفًا بأجوائه
            الديناميكية وتصميمه العصري وروحه المحفزة والتزامه بالحرية في ممارسة
            الرياضة.
          </p>
          ...
          <p className="paraDesign !text-right" data-aos="fade-left">
            ...
            الشغوفين الذين يعتبرون التمارين جزءًا أساسيًا من الحياة. نحن نحرص
            على توفير بيئة داعمة ومحفزة، حيث يجتمع الأعضاء للاحتفال بالإنجازات
            وإلهام بعضهم البعض.
          </p>
          <p className="paraDesign !text-right" data-aos="fade-right">
            في رويال جيم، الشغف هو المحرك لكل ما نقوم به. انضمي إلينا وكوني
            جزءًا من مجتمع يجعل اللياقة أسلوب حياة.
          </p>
        </div>
      </div>
    </>
